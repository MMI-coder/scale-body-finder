...
export const GLOSSARY = [
  ...
  {
    "term": "Measurement Priority Field",
  ...
  {
    "term": "Actual Body Scale",
    "definition": "The actual scale your character fits into. This is a direct comparison of the measurements from the Scale Reference Selector to the real world measurements of the body being viewed. It is intended to help creators know how they should size the clothing, accessories, props, and/or environments for their character that may benefit from being made to the same perceived scale as the character itself."
  },
  {
    "term": "Scale Multiplier",
